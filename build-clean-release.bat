...
:: Create ZIP
cd release
powershell -command "Compress-Archive -Path '*' -DestinationPath 'FyteClub-P2P.zip' -Force"
cd ..

echo.
echo Clean release created: release\FyteClub-P2P.zip
dir release\FyteClub-P2P.zip