...
namespace FyteClub.ModSync.Orchestration
{
    ...
    public class P2PModSyncIntegration : IDisposable
    {
        ...
        private readonly P2PModSyncOrchestrator _orchestrator;
        private readonly FyteClubModIntegration _modIntegration;
        private readonly Dictionary<string, WebRTCConnection> _connections = new();
        ...
        public P2PModSyncIntegration(IPluginLog pluginLog, FyteClubModIntegration modIntegration, SyncshellManager? syncshellManager = null)
        {
            ...
            _orchestrator = new P2PModSyncOrchestrator(pluginLog, modIntegration, syncshellManager);
        ...
        /// </summary>
        public void RegisterConnection(string syncshellId, WebRTCConnection connection)
        {
            if (_disposed) return;
        ...
        /// </summary>
        public void RegisterOrchestrator(P2PModSyncOrchestrator orchestrator)
        {
        ...
        /// <summary>
        /// Convert legacy mod data format to new PlayerInfo format
        /// </summary>
        private PlayerInfo? ConvertLegacyModData(JsonElement data)
        {
            try
            {
