    ...
    public class RedrawManager : IDisposable
    {
        ...
        private unsafe bool IsCharacterDrawing(ICharacter character)
        {
            try
            {
                ...
                // Check render flags (Nameplate bit indicates still rendering)
                return gameObj->RenderFlags == FFXIVClientStructs.FFXIV.Client.Game.Object.VisibilityFlags.Nameplate;
            }
            catch
            {
                return false;
