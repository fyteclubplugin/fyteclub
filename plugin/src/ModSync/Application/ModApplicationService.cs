...
namespace FyteClub.ModSync.Application
{
    ...
    /// </summary>
    public class ModApplicationService : IDisposable
    {
        ...
        public ModApplicationService(IPluginLog pluginLog, FyteClubModIntegration modIntegration)
        {
    ...
    /// Apply a complete outfit atomically using proven mod application patterns.
        ...
        /// <summary>
        /// Convert PeerModState to PlayerInfo with processed files.
        /// </summary>
        private PlayerInfo? ConvertPeerStateToPlayerInfo(PeerModState modState, string playerId, Dictionary<string, string> processedFiles)
        {
            try
            {
        ...
        /// <summary>
        /// Apply player mods directly from PlayerInfo (for P2P protocol)
        /// </summary>
        public async Task<ModApplicationResult> ApplyPlayerMods(PlayerInfo playerInfo)
        {
            try
            {
        ...
        /// <summary>
        /// Generate a state hash for PlayerInfo
        /// </summary>
