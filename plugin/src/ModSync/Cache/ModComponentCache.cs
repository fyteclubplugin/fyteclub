...
namespace FyteClub.ModSync.Cache
{
    ...
    public class ModComponentStorage : IDisposable
    {
        ...
        /// </summary>
        public async Task<string> StoreAppearanceRecipe(string playerName, string appearanceHash, PlayerInfo playerInfo)
        {
            try
            {
        ...
        public async Task<PlayerInfo?> GetCachedAppearanceRecipe(string playerName)
        {
            try
            {
        ...
        public async Task<PlayerInfo?> GetAppearanceFromRecipe(string playerName, string appearanceHash)
        {
            try
            {
                var recipeKey = $"{playerName}:{appearanceHash}";
