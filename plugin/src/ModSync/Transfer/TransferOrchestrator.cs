...
namespace FyteClub.ModSync.Transfer
{
    /// <summary>
    ...
    private readonly ChannelPacingManager _channelPacing;
        ...
        public TransferOrchestrator(IPluginLog pluginLog, P2PModProtocol protocol)
        {
        ...
        /// </summary>
        public async Task SyncModsToPeer(string peerId, PlayerInfo playerInfo, Dictionary<string, TransferableFile> files, Func<byte[], Task> sendFunction)
        {
            try
            {
        ...
        /// </summary>
        private async Task HandleProgressiveSync(string peerId, PlayerInfo playerInfo, Dictionary<string, TransferableFile> files, Func<byte[], Task> sendFunction)
        {
        ...
        /// </summary>
        private async Task HandleDirectSync(string peerId, PlayerInfo playerInfo, Dictionary<string, TransferableFile> files, Func<byte[], Task> sendFunction)
        {
        ...
        private string CalculateDataHash(PlayerInfo playerInfo, Dictionary<string, TransferableFile> files)
        {
        ...
        private PlayerInfo CreatePlayerInfoFromManifest(DifferentialModSync.ModManifest manifest)
        {
        ...
        /// <summary>
        /// Dispose of the TransferOrchestrator and cancel all active transfers
        /// </summary>
        public void Dispose()
        {
            _pluginLog.Info("[SmartTransfer] Disposing TransferOrchestrator");
            ...
            try
            {
                ...
                _pluginLog.Info("[SmartTransfer] TransferOrchestrator disposed successfully");
            }
            catch (Exception ex)
            {
