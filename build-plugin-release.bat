...
if exist FyteClub-Plugin.zip del FyteClub-Plugin.zip
...
powershell Compress-Archive -Path plugin-release\* -DestinationPath FyteClub-Plugin.zip -Force

echo Release built: %cd%\FyteClub-Plugin.zip