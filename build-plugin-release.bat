...
if exist FyteClub-Plugin-v1.0.0.zip del FyteClub-Plugin-v1.0.0.zip
...
powershell Compress-Archive -Path plugin-release\* -DestinationPath FyteClub-Plugin-v1.0.0.zip -Force

echo Release built: %cd%\FyteClub-Plugin-v1.0.0.zip